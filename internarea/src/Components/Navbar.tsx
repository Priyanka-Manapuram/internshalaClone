...
const Navbar = () => {
  ...
  const [frenchOtpModal, setfrenchOtpModal] = useState(false);
  const [frenchOtp, setfrenchOtp] = useState("");
  const [frenchOtpLoading, setfrenchOtpLoading] = useState(false);
    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          {/* Navigation Links — hidden during OTP verification */}
          {!otpPending && (
          ...
          {/* Auth Buttons — hidden during OTP verification */}
          {!otpPending && (
            <div className="flex items-center space-x-4 relative">
              {user ? (
                ...
                <div className="relative flex items-center gap-2">
                  <Link
                    href="/subscription"
                    className="text-xs font-semibold px-3 py-1.5 rounded-full border border-blue-500 text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white transition-colors duration-200 tracking-wide"
                  >
                    {t("plans")}
                  </Link>
