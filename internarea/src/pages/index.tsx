...
export default function SvgSlider() {
    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshalaclone-jby6.onrender.com/api/internship"),
          axios.get("https://internshalaclone-jby6.onrender.com/api/job"),
        ]);
  ...
  return (
    <div className="max-w-7xlmx-auto px-4 sm:px-6 lg:px-8 py-8">
    {/* hero section */}
