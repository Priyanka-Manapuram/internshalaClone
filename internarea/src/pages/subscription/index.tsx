...
const PLANS = [
  {
    ...
    icon: Shield,
    color: "gray",
    features: ["5 applications", "Basic profile", "Job search"],
  },
  {
    name: "Bronze",
    price: 99,
    ...
    icon: Zap,
    color: "orange",
    features: ["25 applications", "Priority listing", "Email support"],
  },
  {
    name: "Silver",
    price: 299,
    ...
    icon: Star,
    color: "blue",
    features: ["75 applications", "Featured profile", "Resume builder"],
    popular: true,
  },
  {
    name: "Gold",
